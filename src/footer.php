<footer class="footer width-full container-xxl mt-4">
    <div class="p-3 position-relative d-flex flex-items-center pb-2 f6 color-fg-muted border-top color-border-muted flex-column-reverse flex-lg-row flex-wrap flex-lg-nowrap mt-6 pt-6">
        <div class="list-style-none d-flex flex-wrap col-0 col-lg-2 flex-justify-start flex-lg-justify-between mb-2 mb-lg-0">
            <div id="footer-brand" class="mt-2 mt-lg-0 d-flex flex-items-center align-items-center">
                <a class="me-4 text-decoration-none" href="index.php"><h3><img class="brand" src="assets/brand/firetracer_shortcut_v2.png" alt="firetracer"></h3></a>
                <span>&copy; 2023 firetracker</span>
            </div>
        </div>
